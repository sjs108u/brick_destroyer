...
function scene:show(event)
    ...
    elseif ( phase == "did" ) then
        ...
        local function createObstacle(x, y)
            local brick = display.newImageRect(sceneGroup, "images/brick/halfbc.png", 100, 100)
            brick.x = x
            brick.y = y
            physics.addBody(brick, "static", {density = 1, friction = 0, bounce = 1})
        end
        ...
        for i = 0,8 do
            createObstacle(70 + 100 * i, 1200)
        end
        createObstacle(890, 1200)
        for i = 0,7 do
            createObstacle(display.contentCenterX - 350, 280 + 100 * i)
            createObstacle(display.contentCenterX + 350, 280 + 100 * i)
        end
        for i = 0,7 do
            createObstacle(display.contentCenterX - 350 + 100 * i, 180)
        end
        for i = 1,5 do
            createObstacle(display.contentCenterX - 350 + 100 * i, 980)
        end
        for i = 1,7 do
            createObstacle(700, 300 + 100 * i - 20)
        end
        createBrick(display.contentCenterX * 0.8, 400)
        createBrick(display.contentCenterX * 0.8, 600)
        
        createObstacle(display.contentCenterX + 350, 280 + 800)
        createObstacle(display.contentCenterX + 350, 280 + 900)
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then 
    elseif ( phase == "did" ) then
        composer.removeScene("default.level3")
    end
end
