...
function scene:show(event)
    ...
    elseif ( phase == "did" ) then
        ...
        for i = 0, 4 do
            createBrick(display.contentCenterX - 400 + 200 * i, 1500+display.contentHeight/18)
        end
        createBrick(display.contentCenterX, display.contentCenterY+display.contentHeight/18)
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then 
    elseif ( phase == "did" ) then
        composer.removeScene("default.level4")
    end
end
