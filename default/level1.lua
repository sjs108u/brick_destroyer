...
function scene:show(event)
    ...
    elseif ( phase == "did" ) then
        ...
        for j = 1, 4 do
                i = 0
                while(i < math.floor(display.contentWidth/200) ) do
                        createBrick(i*205 + 130, 105*j+display.contentHeight/18)
                        i = i + 1
                end
        end
                ...
                if remain_ball > 0 then
                  if balltype == 1 then 
                        ...
                        physics.addBody(ball,"circle",
                            {density = 1, friction = 0, bounce = 1,radius =35}
                        )
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then 
    elseif ( phase == "did" ) then
        composer.removeScene("default.level1")
    end
end
