...
function scene:create( event )
    ...
    local background = display.newImageRect( sceneGroup, "images/background/b3.png" ,display.contentWidth,display.contentHeight )
...
function scene:show(event)
    ...
    elseif ( phase == "did" ) then
        ...
        for i = 0,5 do
        createBrick(display.contentCenterX - 400, 100 + 200 * i+display.contentHeight/18)
            createBrick(display.contentCenterX, 100 + 200 * i+display.contentHeight/18)
            createBrick(display.contentCenterX + 400, 100 + 200 * i+display.contentHeight/18)
        end
        
        for i = 0,5 do
        createObstacle(display.contentCenterX - 400, 200 + 200 * i+display.contentHeight/18)
            createObstacle(display.contentCenterX, 200 + 200 * i+display.contentHeight/18)
            createObstacle(display.contentCenterX + 400, 200 + 200 * i+display.contentHeight/18)
        end      
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then 
    elseif ( phase == "did" ) then
        composer.removeScene("default.level6")
    end
end
